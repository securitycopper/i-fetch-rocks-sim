...
"""
THE MINUS MODULE TAKES TWO 16-BIT VALUES, SUBTRACTS THEM FROM EACH OTHER AND OUTPUTS THEM AS A SINGLE 16-BIT VALUE.

E.G. 1 - 1 = 0

IF THE RESULT IS LESS THAN 0, THE RESULT WILL WRAP AROUND FROM 65535.
...
class Minus:
    ...
    def __init__(self, network_manager: DataNetworkManager, data: dict):
        ...
        self.type = 110
        self.name = 'Minus'
        self.image = 'http://ifetch.rocks/manual/images/DeviceArithmeticMinus.png'
