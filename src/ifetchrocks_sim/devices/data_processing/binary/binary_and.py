...
class BinaryAndGate:
    ...
    def __init__(self, network_manager: DataNetworkManager, data: dict):
        self.data = data
        self.name = 'Binary And Gate'
        self.color = 'blue'
        self.image = 'http://ifetch.rocks/manual/images/DeviceBinaryAND.png'
        self.uuid = data['uuid']
    ...
    def update_and_notify(self):
        # Perform a 16-bit bitwise AND of the two input values
        self.value = (self.in_value_a & self.in_value_b) & 0xFFFF
