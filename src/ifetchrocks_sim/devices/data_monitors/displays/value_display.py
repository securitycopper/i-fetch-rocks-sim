...
class ValueDisplay:
    ...
    def __init__(self, network_manager: DataNetworkManager, data: dict):
        ...
        self.color = 'blue'
        self.image = 'http://ifetch.rocks/manual/images/DeviceAutoValueDisplay.png'
        self.uuid = data['uuid']
        #connections = get_connections_uuids_of_type(data,5)
        self.network_in_1 = get_connection_uuid_by_id(data, '-923971752')
        self.network_out_1 = get_connection_uuid_by_id(data, '1360459028' )
        ...
        self.output_power_networks = [get_connection_uuid_by_id(data, '-172464195')]
